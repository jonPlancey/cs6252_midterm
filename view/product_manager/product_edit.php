...
<main>
    ...
    <form action="../../controller/product_manager/index.php" method="post" id="add_product_form">
        ...
        <input type="text" name="name"  value = "<?php echo  $member['member_name'];?>" />
        <br>

        <label>Birthday</label>
        <input type="text" name="price"	value = "<?php echo  $member['member_birthday'];?>" />
        <br>

        <label>&nbsp;</label>
        <input type="submit" value="Update Product" />
        <input type="hidden" name="product_id" value = "<?php echo $team_id;?>" />
    ...
    <p class="last_paragraph">
        <a href="../../controller/product_manager/index.php?action=list_products">View Member List</a>
    </p>
